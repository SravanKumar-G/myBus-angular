...
export class ExpenseIncomeReportsComponent implements OnInit {
  ...
  getAllExpenseAndIncome(): void{
    this.apiService.get(this.apiUrls.expenseIncomeReportsData + 'date=' + this.currentDate + '&page=' + this.expenseAndIncomeQuery.page +
      ...
      if (res){
        ...
        const totalIncome = 0;
        this.expenseIncomeList.forEach((item) => {
