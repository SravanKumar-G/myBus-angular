...
@Component({
    selector: 'app-service-report-by-service',
    templateUrl: './service-report-by-service.component.html',
    styleUrls: ['./service-report-by-service.component.css']
})
export class ServiceReportByServiceComponent implements OnInit {
